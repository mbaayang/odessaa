...
class mailChannel(models.Model):
    ...
    def send_whatsapp_message(self, message_ids, kwargs, message_id):
        ...
        if not whatsapp_numbers:
            whatsapp_numbers = list(filter(None, [*set(message_ids.mapped('record_name'))]))
        ...
        if whatsapp_numbers:#partner_ids and message_id.author_id and not partner_id:
            ...
            if whatsapp_endpoint and whatsapp_token:
                ...
                # print ('=status_url==',status_url,partner_id,status_response)
                ...
                for whatsapp_number in whatsapp_numbers:
                    if whatsapp_endpoint and whatsapp_token:#(status_response.status_code == 200 or status_response.status_code == 201) and json_response_status['accountStatus'] == 'authenticated':
